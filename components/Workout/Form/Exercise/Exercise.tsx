...
export default function Exercise({ index, name, id, schema, removeExercise, getValues }: ExerciseProps) {
    ...
    return (
        ...
        >
            ...
            <Sets getValues={getValues} sets={sets} exerciseIndex={index} schema={schema} removeSet={removeSet}/>
